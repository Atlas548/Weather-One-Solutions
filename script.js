...
var apiKey = "2dec71e39f0495733603e3c8490344e7";

// Forloop for persistent data on the HMTL page
...
searchButton.click(function () {
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            var urlUV = `https://api.openweathermap.org/data/2.5/uvi?appid=2dec71e39f0495733603e3c8490344e7&lat=${response.coord.lat}&lon=${response.coord.lon}`;
